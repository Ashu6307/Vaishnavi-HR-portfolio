...
export const profile: Profile = {
  fullName: "Vaishnavi Jaiswal",
  initials: "VJ",
  designation: "Human Resources Executive",
  currentCompany: "PCI Infraprojects Pvt. Ltd.",
  headline:
  ...
  values: [
    {
      ...
      description: "Keeping candidates and stakeholders aligned through practical, timely updates."
    },
    {
      title: "Candidate Respect",
      description: "Maintaining professional follow-up and a thoughtful candidate experience."
    },
    {
      title: "Accurate Documentation",
      description: "Treating offer, joining, and HR records as essential parts of a reliable process."
    },
    {
      title: "Process Discipline",
      description: "Moving hiring stages forward through organized tracking and follow-up ownership."
    },
    {
      title: "Timely Follow-Up",
      description: "Reducing ambiguity by tracking pending actions and communication loops."
    },
    {
      title: "Confidentiality",
      description: "Handling candidate and recruitment information with care and discretion."
    },
    {
      title: "Stakeholder Alignment",
      description: "Clarifying requirements before sourcing and during selection coordination."
    },
    {
      title: "Candidate Experience",
      description: "Supporting a smoother journey from first conversation to onboarding support."
    }
  ]
};
